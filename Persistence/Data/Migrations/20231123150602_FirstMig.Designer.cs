...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20231123150602_FirstMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.Entities.Cliente", b =>
                {
                    b.HasOne("Persistence.Entities.Empleado", "IdEmpleadoRepresentanteVentasFkNavigation")
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("Persistence.Entities.DetallePedido", b =>
                {
                    b.HasOne("Persistence.Entities.Pedido", "IdPedidoFkNavigation")
                        .WithMany("DetallePedidos")
                        .HasForeignKey("IdPedidoFk")
                        .IsRequired()
                        .HasConstraintName("idPedidoFk");

                    b.HasOne("Persistence.Entities.Producto", "IdProductoFkNavigation")
                        .WithMany("DetallePedidos")
            ...
            modelBuilder.Entity("Persistence.Entities.Empleado", b =>
                {
                    b.HasOne("Persistence.Entities.Empleado", "IdEmpleadoJefeFkNavigation")
                        .WithMany("InverseIdEmpleadoJefeFkNavigation")
                        .HasForeignKey("IdEmpleadoJefeFk")
                        .HasConstraintName("idEmpleadoJefeFk");

                    b.HasOne("Persistence.Entities.Oficina", "IdOficinaFkNavigation")
                        .WithMany("Empleados")
            ...
            modelBuilder.Entity("Persistence.Entities.Pago", b =>
                {
                    b.HasOne("Persistence.Entities.Cliente", "IdClienteFkNavigation")
                        .WithMany("Pagos")
            ...
            modelBuilder.Entity("Persistence.Entities.Producto", b =>
                {
                    b.HasOne("Persistence.Entities.GamaProducto", "IdGamaFkNavigation")
                        .WithMany("Productos")
